...
|--------|----------|--------|---------|
| Short | 7 days | 30% | Capture recent alpha |
| Medium | 30 days | 40% | Balance responsiveness |
| Long | 90 days | 30% | Reward consistency |
...
All generators stake proportional ante
        ↓
Optional network rake (0-8%, governance-tunable)*
        ↓
Performance evaluation
        ↓
Bottom 20% forfeit ante → 50% burned, 50% to winners
Break-even tier (25%) → ante returned
Profitable tier (45%) → ante + share of winner pool
Top tier (10%) → ante + premium share
```

*Setting the rake to 0% is under consideration, as emissions and external revenue may allow 100% redistribution to winners.
