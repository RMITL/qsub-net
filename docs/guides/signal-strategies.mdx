...
|--------|--------|------------------|--------------|
| Sharpe | 40% | Risk-adjusted returns | Consistent risk-adjusted gains |
| Total P/L | 20% | Absolute returns | Making money |
| Max Drawdown | 15% | Worst peak-to-trough | Capital preservation |
| Sortino | 10% | Return per downside risk | Minimize losses, not volatility |
| Calmar | 10% | Return / max drawdown | Smooth equity curves |
| Turnover | 5% | Trading frequency | Low-frequency rebalancing |
